export default {
  ...
  'tab.backup.desc': '将设置导出到文件并重新导入。',
  'panel.subtitle': '翻译 · 游戏页面 · 价格 · 链接 · 区域 · 缓存 · 备份 · 界面',
  'panel.back': '返回',
  ...
  'block.earlyaccess': '抢先体验提示',
  'gamepage.earlyAccess': '抢先体验版块',
  'gamepage.earlyAccessDesc': '显示完整问答、仅保留精简标题，或完全隐藏该版块。',
  'earlyAccess.full': '完整',
  'earlyAccess.compact': '精简',
  'earlyAccess.hidden': '隐藏',
  ...
  'region.searchTitle': '搜索',
  'region.searchDesc': '用 Steam Plus 搜索替换商店搜索框：带评价和价格的访客结果。',
  'region.searchEnabled': '已启用区域搜索',
  'region.searchEnabledDesc': '隐藏原生搜索并显示我们的。关闭后 Steam 搜索保持原样。',
  'region.searchRows': '结果行数',
  'region.searchRowsDesc': '每次浮层搜索显示多少个游戏。',
  'region.searchNote': '使用本选项卡中的商店国家和代理网关。国家为空时访客结果与您的一致，不会出现额外的行。',
  'region.searchOpen': '打开区域搜索',
  'region.searchHotkey': '提示：在商店任意位置按 / 可打开搜索。',
  'region.proxy': '代理网关',
  ...
  'search.guestTitle': '在其他区域找到 ({country})',
  'search.guestHint': '在您所在区域的搜索中缺失 — 将通过访客加载打开。',
  'search.title': '搜索所有区域',
  'search.placeholder': '在任意区域搜索游戏…',
  'search.loading': '搜索中…',
  'search.empty': '未找到游戏。',
  'search.free': '免费',
  ...
  'backup.export': '导出',
  'backup.exportDesc': '将当前所有设置保存为 JSON 文件，或复制到剪贴板。',
  'backup.download': '下载文件',
  'backup.copy': '复制到剪贴板',
  'backup.copied': '设置已复制到剪贴板。',
  'backup.copyFailed': '无法访问剪贴板。',
  'backup.import': '导入',
  'backup.importDesc': '从之前导出的文件加载设置。当前设置将被覆盖。',
  'backup.chooseFile': '选择文件…',
  'backup.importConfirmTitle': '导入设置？',
  'backup.importConfirm': '当前所有设置将被文件中的值覆盖。',
  'backup.importDone': '设置已导入。',
  'backup.importInvalid': '不是有效的设置文件：未做任何更改。',
