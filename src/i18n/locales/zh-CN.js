export default {
  ...
  'region.cache': '访客页面缓存',
  'region.cacheDesc': '复用已成功加载的访客页面，而不是每次重新请求。',
  'region.cacheMinutes': '缓存时长（分钟）',
  'region.cacheMinutesDesc': '访客页面的复用时长。0 表示禁用缓存；“重新加载”始终重新请求。',
  'region.cacheMax': '最多缓存页面数',
  'region.cacheMaxDesc': '达到上限时保留最新的页面。',
  'region.cacheClear': '清空访客缓存',
  'region.cacheCleared': '已清空访客缓存（{count}）',
  'region.cacheEmpty': '暂无缓存的访客页面。',
  'region.cacheStatus': '{count} 页 · {size}',
  'region.proxy': '代理网关',
