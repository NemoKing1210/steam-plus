export default {
  ...
  'tab.backup.desc': 'Export settings to a file and import them back.',
  'panel.subtitle': 'Translation · game page · prices · links · region · cache · backup · interface',
  'panel.back': 'Back',
  ...
  'scope.newsArticle': 'News article pages',
  'scope.guides': 'Guides',
  ...
  'block.earlyaccess': 'Early Access notice',
  'gamepage.earlyAccess': 'Early Access block',
  'gamepage.earlyAccessDesc': 'Show the full Early Access Q&A, keep only the slim header, or hide the block entirely.',
  'earlyAccess.full': 'Full',
  'earlyAccess.compact': 'Compact',
  'earlyAccess.hidden': 'Hidden',
  ...
  'region.searchTitle': 'Search',
  'region.searchDesc': 'Replace the store search box with Steam Plus search: guest-region results with review and price details.',
  'region.searchEnabled': 'Region search enabled',
  'region.searchEnabledDesc': 'Hide the native search box and show ours instead. Disabled keeps the Steam search untouched.',
  'region.searchRows': 'Result rows',
  'region.searchRowsDesc': 'How many games each overlay search shows.',
  'region.searchNote': 'Uses the store country and proxy gateway from this tab. With an empty country the guest results match your own, so no extra rows appear.',
  'region.searchOpen': 'Open region search',
  'region.searchHotkey': 'Tip: press / anywhere in the store to open the search.',
  ...
  'search.guestTitle': 'Found in another region ({country})',
  'search.guestHint': 'Missing from your store search — opens through the guest fetch.',
  'search.title': 'Search all regions',
  'search.placeholder': 'Search games in any region…',
  ...
  'backup.exportDesc': 'Save all current settings to a JSON file, or copy them to the clipboard.',
  'backup.download': 'Download file',
  'backup.copy': 'Copy to clipboard',
  'backup.copied': 'Settings copied to the clipboard.',
  'backup.copyFailed': 'Could not access the clipboard.',
  'backup.import': 'Import',
  'backup.importDesc': 'Load settings from a previously exported file. Current settings are overwritten.',
  'backup.chooseFile': 'Choose file…',
  'backup.importConfirmTitle': 'Import settings?',
  'backup.importConfirm': 'This overwrites all current settings with the values from the file.',
  'backup.importDone': 'Settings imported.',
  'backup.importInvalid': 'Not a settings file: nothing was changed.',
