export default {
  ...
  'tab.backup.desc': 'Eksportuj ustawienia do pliku i importuj je z powrotem.',
  'panel.subtitle': 'Tłumaczenie · strona gry · ceny · linki · region · pamięć podręczna · kopia · interfejs',
  'panel.back': 'Wstecz',
  ...
  'scope.newsArticle': 'Strony wiadomości',
  ...
  'block.earlyaccess': 'Pasek wczesnego dostępu',
  'gamepage.earlyAccess': 'Blok wczesnego dostępu',
  'gamepage.earlyAccessDesc': 'Pokaż pełne Q&A, zostaw tylko zwarty nagłówek albo ukryj cały blok.',
  'earlyAccess.full': 'Pełny',
  'earlyAccess.compact': 'Zwarty',
  'earlyAccess.hidden': 'Ukryty',
  ...
  'region.searchTitle': 'Wyszukiwanie',
  'region.searchDesc': 'Zastępuje wyszukiwarkę sklepu wyszukiwaniem Steam Plus: wyniki gościa z ocenami i cenami.',
  'region.searchEnabled': 'Wyszukiwanie regionalne włączone',
  'region.searchEnabledDesc': 'Ukrywa natywną wyszukiwarkę i pokazuje naszą. Wyłączona zostawia wyszukiwarkę Steam nietkniętą.',
  'region.searchRows': 'Wiersze wyników',
  'region.searchRowsDesc': 'Ile gier pokazuje każde wyszukiwanie w nakładce.',
  'region.searchNote': 'Używa kraju sklepu i bramy proxy z tej karty. Przy pustym kraju wynik gościa jest taki sam jak twój — dodatkowe wiersze się nie pojawią.',
  'region.searchOpen': 'Otwórz wyszukiwanie regionalne',
  'region.searchHotkey': 'Wskazówka: naciśnij / w dowolnym miejscu sklepu, aby otworzyć wyszukiwarkę.',
  ...
  'search.guestTitle': 'Znaleziono w innym regionie ({country})',
  'search.guestHint': 'Brak w wyszukiwarce twojego regionu — otworzy się przez pobieranie gościa.',
  'search.title': 'Szukaj we wszystkich regionach',
  'search.placeholder': 'Szukaj gier w każdym regionie…',
  'search.loading': 'Szukanie…',
  'search.empty': 'Nie znaleziono gier.',
  'search.free': 'Za darmo',
  ...
  'backup.export': 'Eksport',
  'backup.exportDesc': 'Zapisz bieżące ustawienia do pliku JSON albo skopiuj je do schowka.',
  'backup.download': 'Pobierz plik',
  'backup.copy': 'Kopiuj do schowka',
  'backup.copied': 'Skopiowano ustawienia do schowka.',
  'backup.copyFailed': 'Brak dostępu do schowka.',
  'backup.import': 'Import',
  'backup.importDesc': 'Wczytaj ustawienia z wyeksportowanego pliku. Bieżące ustawienia zostaną nadpisane.',
  'backup.chooseFile': 'Wybierz plik…',
  'backup.importConfirmTitle': 'Zaimportować ustawienia?',
  'backup.importConfirm': 'Wszystkie bieżące ustawienia zostaną zastąpione wartościami z pliku.',
  'backup.importDone': 'Zaimportowano ustawienia.',
  'backup.importInvalid': 'To nie jest plik ustawień: niczego nie zmieniono.',
