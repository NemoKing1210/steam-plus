export default {
  ...
  'panel.subtitle': 'Tłumaczenie · strona gry · ceny · region · pamięć podręczna · interfejs',
  'panel.back': 'Wstecz',
  ...
  'region.cache': 'Pamięć stron gościa',
  'region.cacheDesc': 'Ponownie używa udanych stron gościa zamiast pobierać je od nowa.',
  'region.cacheMinutes': 'Czas cache (minuty)',
  'region.cacheMinutesDesc': 'Jak długo używać strony gościa. 0 wyłącza cache; Odśwież zawsze pobiera od nowa.',
  'region.cacheMax': 'Maks. stron w cache',
  'region.cacheMaxDesc': 'Po osiągnięciu limitu zachowywane są najnowsze strony.',
  'region.cacheClear': 'Wyczyść cache gościa',
  'region.cacheCleared': 'Wyczyszczono cache gościa ({count})',
  'region.cacheEmpty': 'Brak stron gościa w cache.',
  'region.cacheStatus': '{count} stron · {size}',
