export default {
  ...
  'panel.subtitle': '翻訳 · ゲームページ · 価格 · リージョン · キャッシュ · インターフェース',
  'panel.back': '戻る',
  ...
  'region.cache': 'ゲストページキャッシュ',
  'region.cacheDesc': '取得済みのゲストページをしばらく再利用します。',
  'region.cacheMinutes': 'キャッシュ保持（分）',
  'region.cacheMinutesDesc': 'ゲストページの再利用期間。0で無効化、再読み込みは常に新規取得します。',
  'region.cacheMax': '最大キャッシュページ数',
  'region.cacheMaxDesc': '上限到達時は新しいページを優先して保持します。',
  'region.cacheClear': 'ゲストキャッシュを消去',
  'region.cacheCleared': 'ゲストキャッシュを消去しました（{count}）',
  'region.cacheEmpty': 'キャッシュ済みのゲストページはありません。',
  'region.cacheStatus': '{count}ページ · {size}',
