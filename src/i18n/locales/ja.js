export default {
  ...
  'tab.backup.desc': '設定をファイルにエクスポート・インポート。',
  'panel.subtitle': '翻訳 · ゲームページ · 価格 · リンク · リージョン · キャッシュ · バックアップ · インターフェース',
  'panel.back': '戻る',
  ...
  'block.earlyaccess': '早期アクセス案内',
  'gamepage.earlyAccess': '早期アクセスブロック',
  'gamepage.earlyAccessDesc': '完全なQ&Aを表示、スリムなヘッダーのみ残す、またはブロック全体を非表示。',
  'earlyAccess.full': 'フル',
  'earlyAccess.compact': 'コンパクト',
  'earlyAccess.hidden': '非表示',
  ...
  'region.searchTitle': '検索',
  'region.searchDesc': 'ストアの検索ボックスをSteam Plus検索に置き換えます。評価と価格付きのゲスト結果。',
  'region.searchEnabled': '地域検索を有効化',
  'region.searchEnabledDesc': 'ネイティブ検索を隠してこちらを表示します。無効のままではSteam検索は変更されません。',
  'region.searchRows': '結果の行数',
  'region.searchRowsDesc': 'オーバーレイ検索ごとに表示するゲーム数。',
  'region.searchNote': 'このタブのストア国とプロキシゲートウェイを使用します。国が空の場合、ゲスト結果は自分の結果と同じになり、追加の行は表示されません。',
  'region.searchOpen': '地域検索を開く',
  'region.searchHotkey': 'ヒント：ストア内のどこでも / を押すと検索が開きます。',
  ...
  'search.guestTitle': '他のリージョンで見つかりました ({country})',
  'search.guestHint': 'お住まいの地域の検索にありません — ゲスト取得で開きます。',
  'search.title': '全リージョンを検索',
  'search.placeholder': 'あらゆる地域のゲームを検索…',
  'search.loading': '検索中…',
  'search.empty': 'ゲームが見つかりません。',
  'search.free': '無料',
  ...
  'backup.exportDesc': '現在の設定をすべてJSONファイルに保存、またはクリップボードにコピー。',
  'backup.download': 'ファイルをダウンロード',
  'backup.copy': 'クリップボードにコピー',
  'backup.copied': '設定をクリップボードにコピーしました。',
  'backup.copyFailed': 'クリップボードにアクセスできませんでした。',
  'backup.import': 'インポート',
  'backup.importDesc': 'エクスポート済みファイルから設定を読み込み。現在の設定は上書きされます。',
  'backup.chooseFile': 'ファイルを選択…',
  'backup.importConfirmTitle': '設定をインポートしますか？',
  'backup.importConfirm': '現在の設定はすべてファイルの値で上書きされます。',
  'backup.importDone': '設定をインポートしました。',
  'backup.importInvalid': '設定ファイルではありません：何も変更されませんでした。',
