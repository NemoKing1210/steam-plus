export default {
  ...
  'tab.backup.desc': '설정을 파일로 내보내고 가져오기.',
  'panel.subtitle': '번역 · 게임 페이지 · 가격 · 링크 · 지역 · 캐시 · 백업 · 인터페이스',
  'panel.back': '뒤로',
  ...
  'block.earlyaccess': '앞서 해보기 안내',
  'gamepage.earlyAccess': '앞서 해보기 블록',
  'gamepage.earlyAccessDesc': '전체 Q&A 표시, 슬림 헤더만 유지, 또는 블록 전체 숨기기.',
  'earlyAccess.full': '전체',
  'earlyAccess.compact': '간략히',
  'earlyAccess.hidden': '숨김',
  ...
  'region.searchTitle': '검색',
  'region.searchDesc': '상점 검색창을 Steam Plus 검색으로 교체합니다. 평가와 가격이 포함된 게스트 결과.',
  'region.searchEnabled': '지역 검색 사용',
  'region.searchEnabledDesc': '네이티브 검색을 숨기고 이 검색을 표시합니다. 끄면 Steam 검색이 그대로 유지됩니다.',
  'region.searchRows': '결과 행 수',
  'region.searchRowsDesc': '오버레이 검색마다 표시할 게임 수.',
  'region.searchNote': '이 탭의 상점 국가와 프록시 게이트웨이를 사용합니다. 국가가 비어 있으면 게스트 결과가 내 결과와 같아 추가 행이 나타나지 않습니다.',
  'region.searchOpen': '지역 검색 열기',
  'region.searchHotkey': '팁: 상점 어디에서나 /를 누르면 검색이 열립니다.',
  ...
  'search.guestTitle': '다른 지역에서 찾음 ({country})',
  'search.guestHint': '내 지역 검색에 없음 — 게스트 가져오기로 열립니다.',
  'search.title': '모든 지역 검색',
  'search.placeholder': '모든 지역에서 게임 검색…',
  'search.loading': '검색 중…',
  'search.empty': '게임을 찾을 수 없습니다.',
  'search.free': '무료',
  ...
  'backup.export': '내보내기',
  'backup.exportDesc': '현재 모든 설정을 JSON 파일로 저장하거나 클립보드에 복사.',
  'backup.download': '파일 다운로드',
  'backup.copy': '클립보드에 복사',
  'backup.copied': '설정이 클립보드에 복사되었습니다.',
  'backup.copyFailed': '클립보드에 접근할 수 없습니다.',
  'backup.import': '가져오기',
  'backup.importDesc': '내보낸 파일에서 설정을 불러옵니다. 현재 설정은 덮어씁니다.',
  'backup.chooseFile': '파일 선택…',
  'backup.importConfirmTitle': '설정을 가져오겠습니까?',
  'backup.importConfirm': '현재 모든 설정이 파일의 값으로 덮어씁니다.',
  'backup.importDone': '설정을 가져왔습니다.',
  'backup.importInvalid': '설정 파일이 아닙니다. 변경된 내용이 없습니다.',
