export default {
  ...
  'panel.subtitle': '번역 · 게임 페이지 · 가격 · 지역 · 캐시 · 인터페이스',
  'panel.back': '뒤로',
  ...
  'region.cache': '게스트 페이지 캐시',
  'region.cacheDesc': '성공한 게스트 페이지를 잠시 재사용합니다.',
  'region.cacheMinutes': '캐시 유지 (분)',
  'region.cacheMinutesDesc': '게스트 페이지 재사용 기간. 0이면 비활성화, 새로고침은 항상 새로 가져옵니다.',
  'region.cacheMax': '최대 캐시 페이지 수',
  'region.cacheMaxDesc': '상한에 도달하면 최신 페이지를 우선 보관합니다.',
  'region.cacheClear': '게스트 캐시 지우기',
  'region.cacheCleared': '게스트 캐시를 지웠습니다 ({count})',
  'region.cacheEmpty': '캐시된 게스트 페이지가 없습니다.',
  'region.cacheStatus': '{count}페이지 · {size}',
